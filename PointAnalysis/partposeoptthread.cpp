...
{
	m_parts_solver.optimizeAttributes(*m_parts_structure, *m_predictor, param_opt_single_energy_term_weight,
	...
	if (use_symmetry)
	{
		...
		m_parts_solver.optimizeAttributes(*m_parts_structure, *m_predictor, param_opt_single_energy_term_weight,
			param_opt_symmetry_energy_term_weight, param_opt_max_iterations, true);
	}
}